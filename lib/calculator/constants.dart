...
const kInactiveCardColor = Color(0xFF111385);
...
const kLargeButtonTextStyle = TextStyle(fontSize: 30.0, color: Colors.white, fontWeight: FontWeight.bold);

const kTitleTextStyle = TextStyle(fontSize: 50.0, fontWeight: FontWeight.bold, );

const kResultTextStyle = TextStyle(color: Colors.orange, fontSize: 22.0, fontWeight: FontWeight.bold);
